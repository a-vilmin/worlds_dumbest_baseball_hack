...
for player in players:
    season_url = "http://www.brooksbaseball.net/tabs.php?player={}&p_hand=-1&ppos=-1&cn=200&compType=none&risp=0&1b=0&2b=0&3b=0&rType=perc&time=month&minmax=ci&var=traj&s_type=2&startDate=10/01/2015&endDate=11/01/2015&gFilt=allmlb".format(player["id"])
...
with open("october_pitchers_data.json", "w") as outputfile:
