...
for player in players:
    ...
    month_url = "http://www.brooksbaseball.net/h_tabs.php?player={}&balls=-1&strikes=-1&b_hand=-1&time=month&minmax=ci&var=ra&s_type=16&gFilt=allmlb&startDate=06/01/2015&endDate=07/01/2015".format(player["id"])
...
with open("june_monthly_batters.json", "w") as outputfile:
